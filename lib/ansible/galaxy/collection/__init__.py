...
try:
    ...
    # NOTE: The type ignore is a hack for mypy to shut up wrt bug #1153
        ...
        for collection in collections:
            try:
                ...
                try:
                    ...
                    if e.message == 'Failed to find collection {coll.fqcn!s}:{coll.ver!s}'.format(coll=collection):  # FIXME: extract the actual message and adjust this
                        raise AnsibleError(
...
# FIXME: accept a dict produced from `galaxy.yml` 
