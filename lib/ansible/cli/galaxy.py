...
class GalaxyCLI(CLI):
    ...
    def execute_download(self, artifacts_manager=None):
        ...
        download_collections(requirements, download_path, self.api_servers, no_deps,
    ...
    def execute_verify(self, artifacts_manager=None):
        ...
        verify_collections(requirements, resolved_paths, self.api_servers, ignore_errors,
    ...
    def _execute_install_collection(
        ...
        install_collections(requirements, output_path, self.api_servers, ignore_errors,
