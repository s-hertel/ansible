    ...
    def execute_list_collection(self):
        ...
        for path in collections_search_paths:
            ...
            if collection_name:
                ...
                collection = CollectionRequirement.from_path(b_collection_path, False, only_installed=False)
                ...
                if os.path.isdir(collection_path):
                    ...
                    collections = find_existing_collections(collection_path, only_installed=False)
                else:
